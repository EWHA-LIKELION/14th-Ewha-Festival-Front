  ...
  if (variant === 'underline') {
    return (
      <div className="relative h-9 w-full">
        {/* 전체 너비 배경 라인 */}
        <div className="absolute top-8 left-0 h-0.5 w-full bg-zinc-100" />
        ...
        {/* 이동하는 언더라인 인디케이터 */}
        <div
          className="absolute top-8 z-5 h-0.5 w-20 bg-emerald-600 transition-[left] duration-300 ease-in-out"
