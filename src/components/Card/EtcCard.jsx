...
const EtcCard = ({ title, description, selected = false, onClick }) => {
  return (
    <div
      onClick={onClick}
      className={`flex w-full cursor-pointer flex-col items-start justify-center rounded-xl border p-5 ${selected ? 'border-emerald-400 bg-emerald-50' : 'border-zinc-200 bg-white'}`}
    >
