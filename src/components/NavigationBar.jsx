...
const NavigationBar = () => {
  ...
  return (
    <div
      className="fixed bottom-0 left-1/2 z-10 flex h-15 w-[392px] -translate-x-1/2 items-center justify-between border-t border-gray-100 bg-white px-7 text-xs font-medium"
