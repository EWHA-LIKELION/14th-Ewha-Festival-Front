...
const BottomsheetScrim = ({ size = 'medium', onClose, children }) => {
  ...
  return (
    <>
      ...
      <div
        className={`reactive-width shadow-up-md fixed bottom-0 left-1/2 z-15 flex w-full flex-col overflow-clip rounded-t-3xl bg-white transition-transform duration-300 ease-out ${SHEET_HEIGHT_CLASS[size]}`}
